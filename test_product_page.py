...
def test_guest_can_add_product_to_basket(browser, link):
    ...
    page.should_be_basket_total_equal_price(product_price)
...
@pytest.mark.xfail(reason="Success message does not disappear (known bug)")
...
def test_guest_cant_see_product_in_basket_opened_from_product_page(browser):
    ...
    basket_page.should_have_empty_message()
